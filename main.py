...
class WoWBackupApp:
    ...
    def _restore_directory(self, source_dir, dest_dir, dir_name):
        ...
        try:
            ...
            if platform.system() == 'Windows':
                # Use robocopy for maximum speed on Windows
    ...
    def setup_tray(self):
        """Setup system tray (simplified - just minimize to taskbar)"""
        self.tray_icon = None
        # For now, we'll just use minimize to taskbar
        # System tray functionality can be added later with optional dependencies
    ...
    def hide_to_tray(self):
        """Hide window (minimize to taskbar)"""
        self.root.iconify()
